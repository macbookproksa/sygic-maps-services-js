(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sygicMapsServices"] = factory();
	else
		root["sygicMapsServices"] = factory();
})(window, function() {
...
var _validate = __webpack_require__(/*! ../util/validate */ "./src/util/validate.js");
...
exports.optimization = {
  ...
  validator: validate.object({
    settings: validate.optional(validate.object({
      ...
      max_tour_count: validate.optional(validate.positiveNumber),
    ...
    locations: validate.array(validate.object({
      ...
      availability: validate.optional(validate.object({
...
exports.directions = {
  ...
  validator: validate.object({
    ...
    avoid: validate.optional(validate.pipedArrayOf(validate.oneOf(['tolls', 'highways', 'ferries', 'unpaved']))),
    ...
    vehicle_type: validate.optional(validate.oneOf(['car', 'camper', 'van', 'truck'])),
...
exports.distanceMatrix = {
  ...
  validator: validate.object({
    ...
    units: validate.optional(validate.oneOf(['metric', 'imperial'])),
    vehicle_type: validate.optional(validate.oneOf(['car', 'truck', 'heavytruck'])),
    max_speed: validate.optional(validate.numberRange(1, 255))
  })
};
...
exports.sendToNavi = {
  ...
  validator: validate.object({
    message: validate.optional(validate.string),
...
exports.autocomplete = {
  ...
  validator: validate.object({
    ...
    includeDetails: validate.optional(validate.bool)
  })
};
...
var _geocoding = __webpack_require__(/*! ./api/geocoding */ "./src/api/geocoding.js");

var _routing = __webpack_require__(/*! ./api/routing */ "./src/api/routing.js");

var _search = __webpack_require__(/*! ./api/search */ "./src/api/search.js");

var _optimization = __webpack_require__(/*! ./api/optimization */ "./src/api/optimization.js");

var _webApiCall = __webpack_require__(/*! ./util/webApiCall */ "./src/util/webApiCall.js");
...
//# sourceMappingURL=sygic-maps-services.js.map